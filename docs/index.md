...
<p class="subtitle">Clinical Data Linkage Manager · FHIR &amp; Clinical Informatics</p>
...
I work on clinical data linkage and health data interoperability. Right now I
coordinate perinatal data extraction across around 58 Victorian hospital sites
at Murdoch Children's Research Institute. Before Melbourne I spent close to four
years at Genomics England, embedded in the NHS Genomic Medicine Service, working
on FHIR implementation for national genomic diagnostics.
...
**Clinical Data Linkage Manager**<br>
<span class="entry-org">Generation Victoria (GenV), Murdoch Children's Research Institute</span>
</div>
...
<div class="entry" markdown>
<div class="entry-main" markdown>
**Junior Research Engineer**<br>
<span class="entry-org">Barcelona Supercomputing Center</span>
</div>
<div class="entry-meta" markdown>
...
<div class="entry" markdown>
<div class="entry-main" markdown>
**MSc in Precision Medicine and Health Bioinformatics**<br>
...
- **HL7 FHIR Implementer Foundational** <span class="cert-issuer">HL7 International</span>
- **SNOMED CT Foundation** <span class="cert-issuer">SNOMED International</span>
- **AWS Certified Cloud Practitioner** <span class="cert-issuer">Amazon Web Services</span>
...
Earlier research and applied work. The full list lives on the
...
-   :material-notebook-outline:{ .lg .middle } **Notes**
    ...
    Working notes on the command line, SQL, Python, R for biostatistics, machine
    learning, MongoDB and bioinformatics tooling.

    [:octicons-arrow-right-24: Browse the notes](notes/index.md)
